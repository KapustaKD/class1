...
const creativeGames = {
    'chronicles': {
        ...
        description: 'Вам необхідно вигадати цікаву історію. Кожному гравцеві буде надано 5 спроб написати речення, яке стане логічним продовженням речення попереднього гравця. Час для написання кожного речення - 15 секунд. Якщо продовження не буде написане та відправлене протягом цього часу - гравець вибуває. Успіхів!',
    ...
    'great_pedagogical': {
        ...
        description: 'Вам необхідно за 1 хвилину згадати або вигадати найкращий, найсмішніший, найсечогонніший анекдот в історії людства. Рішення про надання титулу “Великий Педагогічний…” прийматимуть усі гравці через голосування. Не поспішайте, гумор любить спокій.',
    ...
    'pedagog_mom': {
        ...
        description: 'Вам необхідно за одну хвилину вигадати на коротко описати найкращий спосіб навчити чомусь іншого. Рішення про надання титулу “Я у мами педагог” прийматимуть усі гравці через голосування. Успіхів тобі, гравець!',
        rules: 'Один гравець пише, інші голосують за найкращий варіант.',
        timer: 60,
        type: 'creative_writing'
    }
